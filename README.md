# Musical-World
Musical World is a web application that basically alow user to upload their own songs and can listen to already uploaded songs and can add their song into favorite list.
